...
object MmkvManager {
    ...
    /**
     * Encodes the server test delay in milliseconds and location.
     *
     * @param guid The server GUID.
     * @param testResult The test delay in milliseconds.
     * @param testLocation The test location (optional).
     */
    fun encodeServerTestDelayMillis(guid: String, testResult: Long, testLocation: String? = null) {
        if (guid.isBlank()) {
            return
        }
